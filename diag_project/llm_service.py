...
{{
  ...
  "evidence_list": [
    "인터뷰 발언 원문 그대로 인용 1 — 평가의 절대적 근거가 되는 [실제 대화 발췌문]. AI 창작 절대 금지, 발언에 없으면 생략",
  ...
  "gap_analysis": "반드시 '향후 이상적인 리더십 역량 개발을 위해서는'으로 시작하는 발전적 코칭 문장 2개(각 50자 내외 단문). 이 리더에게 지금 가장 필요한 한 가지를 행동 가능한 조건으로 제시. ('만점', '5.0', '점수 도달' 같은 점수 언급 표현 절대 금지)",
