...
def _get_instruction_guide(instruction: str) -> str:
    ...
    guides = {
        ...
        "RAPPORT_BUILDING": (
            "라포 형성 단계입니다. 시스템이 첫 인사를 이미 보냈으니 "
            "당신은 사용자의 답변부터 받아 자연스럽게 대화를 이어가세요. "
            "본격 진단 (사건 수집) 은 아직 시작하지 마세요.\n\n"
            "사용자가 호칭·근황을 알려주면 그걸 따뜻하게 인정하고 "
            "짧은 일상 대화 후 자연스럽게 진단 흐름으로 넘어갈 준비를 하세요.\n\n"
            "**라포가 충분히 됐다고 느끼면**: 응답 끝에 [START_CHAPTER] 태그를 "
            "포함하세요. 이 태그가 있으면 다음 턴부터 본격 진단이 시작됩니다.\n\n"
            "예시 (적극적인 사용자, 1-2턴 후):\n"
            "  '좋습니다, 김 대표님! 그럼 오늘 본격적으로 시작해볼까요? [START_CHAPTER]'\n\n"
            "예시 (긴장한 사용자, 2-3턴 더 라포 후):\n"
            "  '천천히 함께 해봐요. 준비되셨으면 시작할게요. [START_CHAPTER]'\n\n"
            "라포 길이 가이드:\n"
