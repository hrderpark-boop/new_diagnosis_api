...
def _get_instruction_guide(
    ...
    guides = {
        ...
        "DIAGNOSIS_INTRO": (
            "진단 안내 — 호응 부분(사용자 기대 답변 paraphrase)만 생성하는 단계.\n\n"
            "이 응답은 하이브리드입니다:\n"
            "- LLM (당신) → 사용자 기대 답변에 대한 호응만 생성 (2-3문장)\n"
            "- 시스템 → 진단 안내 본문 (5개 영역, 시간, 형식) 자동 추가\n"
            "따라서 당신은 호응 부분만 출력하고 끝내세요.\n\n"
            "**필수 응답 형식 (2-3문장)**:\n"
            "1. 사용자가 기대하는 것을 구체적으로 paraphrase\n"
            "2. 의미 부여 또는 격려\n\n"
            "**예시 1 (기대: '리더십 역량을 확인하고 싶어요')**:\n"
            "  '리더십 역량을 객관적으로 확인하고 싶으신 거군요. 좋은 동기예요. "
            "이번 진단을 통해 리더님의 강점과 더 키워볼 만한 부분을 함께 "
            "발견하실 수 있을 거예요.'\n\n"
            "**예시 2 (기대: '잘 모르겠어요' / 막연)**:\n"
            "  '편하게 진행하시면 됩니다. 차근차근 이야기 나누다 보면 "
            "자연스럽게 리더님의 모습이 드러날 거예요.'\n\n"
            "**⛔ 절대 금지 (시스템이 자동 추가하므로 출력 X)**:\n"
            "- '본격적으로 시작하기 전에 진단에 대해 안내드리겠습니다' → 시스템 담당\n"
            "- '5개 영역의 리더십 진단' 같은 안내 본문 → 시스템 담당\n"
            "- '조직관리, 성과관리...' 영역 나열 → 시스템 담당\n"
            "- '약 30분', '2-3시간' 시간 안내 → 시스템 담당\n"
            "- '이해되셨을까요?' 마무리 질문 → 시스템 담당\n"
            "- BEI 질문 / 3문장 초과\n\n"
            "톤: 페르소나 살리되 호응 부분만 출력하고 끝내기."
        ),
        "DIAGNOSIS_CONFIRM": (
            ...
            "**긍정인 경우 응답 — 준비 인사 + 챕터 도입 + 정의 묻기 (한 응답)**:\n\n"
            "사용자가 '네' 같은 동의를 표현하면, 다음 세 부분을 한 응답에 통합:\n"
            "1. 준비 인사 (짧게)\n"
            "2. 첫 번째 영역 '조직관리' 도입 (한 문장)\n"
            "3. '조직관리'가 무엇이라고 생각하세요? (정의 묻기)\n\n"
            "  좋은 예시 1:\n"
            "    '준비되셨다니 좋습니다. 그럼 이제 본격적으로 첫 번째 영역인 "
            "'조직관리'에 대해 이야기 나눠볼까요? 시작하기 전에, 리더님께서는 "
            "'조직관리'가 무엇이라고 생각하세요? 편하게 들려주세요. "
            "[START_CHAPTER]'\n\n"
            "  좋은 예시 2:\n"
            "    '편하게 진행해보겠습니다. 첫 번째 영역인 '조직관리' 부터 함께 "
            "살펴볼게요. 리더님은 '조직관리'를 어떻게 정의하세요? "
            "[START_CHAPTER]'\n\n"
            "  → [START_CHAPTER] 태그 필수.\n\n"
            "⛔ 절대 금지:\n"
            "  X 준비 인사만 하고 끝내기 ('준비됐다니 좋습니다.' 만 X)\n"
            "  X 정의 질문 없이 [START_CHAPTER] 보내기\n"
            "  X BEI 질문 (사건/경험 묻기) — 정의만 묻기\n"
            "  X 진단 안내 반복 (INTRO 에서 이미 함)\n\n"
            ...
            "- BEI 질문 미리 시작\n"
            "- 첫 영역 진입\n\n"
            "[START_CHAPTER] 태그 포함 시 다음 턴부터 ALIGN → CHAPTER_OPENING "
            "으로 이어집니다. 사용자가 정의를 답변하면 자동으로 진행됩니다."
        ),
        "CONTINUE_NORMAL": (
