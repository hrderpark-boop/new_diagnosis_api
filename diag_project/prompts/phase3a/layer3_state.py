...
def _get_instruction_guide(
    ...
    guides = {
        ...
        "DIAGNOSIS_CONFIRM": (
            ...
            "  예시 3 (긴 답변, 의미 있음):\n"
            "    [사용자 답변 짧게 의미 부여] + '[START_CHAPTER]'\n\n"
            "  → 다음 턴이 COMPETENCY_INTRO "
            "('조직관리 영역부터 시작하겠습니다') 이므로\n"
            "    '시작할게요', '이야기 나눠볼게요' 표현은 절대 X (중복).\n"
            "  → 부드럽게 분위기 전환 + [START_CHAPTER] 태그만.\n\n"
